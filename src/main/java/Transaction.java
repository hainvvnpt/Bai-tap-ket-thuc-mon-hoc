...
public class Transaction {
    ...
    public boolean processTransaction() {
        ...
        for(TransactionInput i : inputs) {
            i.UTXO =NVH_Blockchain.UTXOs.get(i.transactionOutputId);
        }
        //Kiểm tra giao dịch hợp lệ
        if(getInputsValue() < NVH_Blockchain.minimumTransaction) {
            System.out.println("Số lượng VNPT-Net Router bạn chon quá bé : " + getInputsValue());
            System.out.println("Vui lòng nhập lại số lượng lớn hơn : " + NVH_Blockchain.minimumTransaction);
            return false;
        }
        ...
        for(TransactionOutput o : outputs) {
            NVH_Blockchain.UTXOs.put(o.id , o);
        }
        ...
        for(TransactionInput i : inputs) {
            ...
            NVH_Blockchain.UTXOs.remove(i.UTXO.id);
        }
        return true;
    }
