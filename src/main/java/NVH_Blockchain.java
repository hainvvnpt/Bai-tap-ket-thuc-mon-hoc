...
public class NVH_Blockchain {
    public static ArrayList<VNPT_Hai> blockchain = new ArrayList<VNPT_Hai>();
    public static int difficulty = 5;
    public static float minimumTransaction = 0.1f;
    public static NVH_Store NVH_Kho; //Kho
    public static NVH_Store NVH_Cuahang; //Cửa hàng
    ...
    public static void main(String[] args) {
        ...
        //Tạo ra các store
        NVH_Kho = new NVH_Store();
        NVH_Cuahang = new NVH_Store();
        NVH_Store coinbase = new NVH_Store();
        ...
        genesisTransaction = new Transaction(coinbase.publicKey, NVH_Kho.publicKey, initBalanceA, null);
        ...
        VNPT_Hai genesis = new VNPT_Hai("0");
        genesis.addTransaction(genesisTransaction);
        addBlock(genesis);
        System.out.println("-Số lượng VNPT-Net Router trong kho là : " + NVH_Kho.getBalance());
        ...
        genesisTransaction = new Transaction(coinbase.publicKey, NVH_Cuahang.publicKey, initBalanceB, null);
        genesisTransaction.generateSignature(coinbase.privateKey); //Gán private key (ký thủ công) vào giao dịch gốc
        ...
        genesis.addTransaction(genesisTransaction);
        addBlock(genesis);
        System.out.println("-Số lượng VNPT-Net Router đang có tại Cửa hàng là : " + NVH_Cuahang.getBalance());
        VNPT_Hai block1 = new VNPT_Hai(genesis.hash);
        boolean fail = true;
        while (fail){
            ...
            sendFund = NVH_Kho.sendFunds(NVH_Cuahang.publicKey, numberTransfer);
            if (sendFund==null){
                continue;
            }else{
                fail= false;
        ...
        System.out.println("-Số lượng VNPT-Net Router trong kho hiện tại là : " + NVH_Kho.getBalance());
        System.out.println("-Số lượng VNPT-Net Router của Cửa hàng hiện tại là : " + NVH_Cuahang.getBalance());
    }
    public static Boolean isChainValid() {
        VNPT_Hai currentBlock;
        VNPT_Hai previousBlock;
    ...
    public static void addBlock(VNPT_Hai newBlock) {
        newBlock.mineVNPT_Hai(difficulty);
